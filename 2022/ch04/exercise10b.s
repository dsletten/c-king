...
exercise10:     file format elf64-x86-64
...
0000000000001070 <exit@plt>:
    ...
    1074:	f2 ff 25 55 2f 00 00 	bnd jmp QWORD PTR [rip+0x2f55]        # 3fd0 <exit@GLIBC_2.2.5>
...
0000000000001169 <main>:
    ...
    1175:	c7 45 fc 01 00 00 00 	mov    DWORD PTR [rbp-0x4],0x1
    117c:	8b 55 fc             	mov    edx,DWORD PTR [rbp-0x4]
    117f:	8d 42 01             	lea    eax,[rdx+0x1]
    1182:	89 45 fc             	mov    DWORD PTR [rbp-0x4],eax
    1185:	8b 45 fc             	mov    eax,DWORD PTR [rbp-0x4]
    1188:	8d 48 ff             	lea    ecx,[rax-0x1]
    118b:	89 4d fc             	mov    DWORD PTR [rbp-0x4],ecx
    118e:	01 d0                	add    eax,edx
    ...
    11a1:	e8 ba fe ff ff       	call   1060 <printf@plt>
    11a6:	bf 00 00 00 00       	mov    edi,0x0
    11ab:	e8 c0 fe ff ff       	call   1070 <exit@plt>
