 ...
 *      interest_monthly.c
 *
 *   Synopsis: Exercise 8-6 (见 2021 for use of pow())
 *
 *   Revision History:
...
int get_interest_rate() {
  return get_int_in_range("Enter interest rate: ", 0, 100);
}

int get_years() {
  return get_int_in_range("Enter number of years: ", 1, 20);
}
